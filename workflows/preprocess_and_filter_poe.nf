...
workflow preprocess_and_filter_poe {
    ...
    filter_poe(filter_clustered_variants.out.vcf,panel_of_errors_fa,regions_input)
    filter_centromere_segdups(filter_poe.out.vcf,segdup_regions,centromere_regions,simple_repeat_regions,kg_indels,regions_input)

    emit:
    filter_centromere_segdups.out.vcf
}
