...
def main():
    parser = argparse.ArgumentParser(
        description="Assign HighConf / ModerateConf / LowConf FILTERs to variants"
    )
    parser.add_argument(
    ...
    if "ModerateConf" not in header.filters:
        header.filters.add("ModerateConf", None, None, "Moderate confidence variant")
    ...
    for rec in vcf_in:
        ...
        # Else if CrossCaller OR CrossTissue → ModerateConf
        # Else → LowConf
