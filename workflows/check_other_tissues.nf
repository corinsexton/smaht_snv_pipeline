...
workflow check_other_tissues {
    ...
    // Step 1: Split VCF into per-chromosome chunks
    ...
    chunk_groups
        ...
        .map { id, mp_vcfs, mp_tbis, truth_vcfs, truth_tbis,
                vcf, tbi, truth_vcf, truth_vcf_tbi, sr_bams, sr_bais, tissue_ids ->
                tuple(id, mp_vcfs, mp_tbis, vcf, tbi, truth_vcf, truth_vcf_tbi) }
        .set { merged_minipileup_sr_input }

    merge_minipileup_sr_only_chunks(merged_minipileup_sr_input)
